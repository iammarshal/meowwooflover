package com.example.meowwooflover.Api;

import com.example.meowwooflover.Constant.AppInfo;
import com.example.meowwooflover.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
     ...
     public JSONObject createOrder(String amount) throws Exception {
        ...
        JSONObject data = com.example.meowwooflover.Api.HttpProvider.sendPost(AppInfo.URL_CREATE_ORDER, formBody);
        return data;
    }
}
